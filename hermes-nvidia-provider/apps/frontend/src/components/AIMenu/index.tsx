...
import { useHermesAgent, type ToolEvent } from '../../lib/useHermesAgent';
...
export default function AIMenu({ userId, currentRepo, currentBranch, currentFile }: AIMenuProps) {
  ...
  const {
    messages, status, isStreaming, isThinking, activeTools, charsStreamedSoFar,
    send, ingest, clearMemory, setContext, clearMessages,
...
function Header({ status, statusColor, activeTools, onClearMemory, onClearMessages, onToggleContext }: {
